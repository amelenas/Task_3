...
public class ReplaceWordOnSubstringTest {
    ...
    public void replaceWordsNull() throws Task03Exception {
        String text = null;
        String result = replaceWordOnSubstring.replaceWordsRegular(text, 7, "*******");
        System.out.println(result);
    }
    ...
    @Test(expected = Task03Exception.class)
    public void replaceWordsRegularNull() throws Task03Exception {
        String text = null;
        String result = replaceWordOnSubstring.replaceWords(text, 7, "*******");
        System.out.println(result);
    }
    ...
    @Test(expected = Task03Exception.class)
    public void replaceNegativeLength() throws Task03Exception {
        String text = null;
        String result = replaceWordOnSubstring.replaceWordsRegular(text, -7, "*******");
        System.out.println(result);
    }
    ...
    @Test(expected = Task03Exception.class)
    public void replaceWordsNegativeLength() throws Task03Exception {
        String text = null;
        String result = replaceWordOnSubstring.replaceWords(text, -7, "*******");
        System.out.println(result);
    }
